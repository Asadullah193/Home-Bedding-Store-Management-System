...
.login-form-3 {
    padding: 5%;
    box-shadow: 0 5px 8px 0 rgba(49, 13, 193, 0.88), 0 9px 26px 0 rgba(0, 0, 0, 0.19);
    backdrop-filter: blur(20px);
}

.login-form-1 {
    padding: 5%;
    box-shadow: 0 5px 8px 0 rgba(61, 13, 236, 0.88), 0 9px 26px 0 rgba(0, 0, 0, 0.19);
    backdrop-filter: blur(20px);
}
    </style>
    <body >
...
<div class="container login-container">
    <h1 style="color:white; backdrop-filter: blur(20px); "><b>Home Bedding Store Management System</b></h1>
